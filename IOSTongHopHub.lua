loadstring(game:HttpGet(("https://raw.githubusercontent.com/daucobonhi/Ui-Redz-V2/refs/heads/main/UiREDzV2.lua")))()
       ...
       local Window = MakeWindow({
         Hub = {
         Title = "IOSTongHopHub",
         Animation = "source by hieudrg"
         },
        Key = {
        KeySystem = true,
        Title = "IOSKING | TONGHOP",
        Description = "Blox Fruit TongHop",
        KeyLink = "https://discord.gg/KDJkWC7JY2",
        Keys = {"freekey-ioslavuanhecaccon2200"},
        Notifi = {
        Notifications = true,
        CorrectKey = "key đúng",
       Incorrectkey = "key sai vui lòng thử lại",
       CopyKeyLink = "https://discord.gg/KDJkWC7JY2"
      }
    }
  })

       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id=94439769761633",
       Size = {60, 60},
